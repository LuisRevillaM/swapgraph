...
const MILESTONE = 'M132';
const SCENARIO_FILE = 'fixtures/release/m132_scenario.json';
const EXPECTED_FILE = 'fixtures/release/m132_expected.json';
const OUTPUT_FILE = 'typescript_service_proposal_lifecycle_helper_parity_output.json';
