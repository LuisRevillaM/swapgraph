...
const MILESTONE = 'M127';
const SCENARIO_FILE = 'fixtures/release/m127_scenario.json';
const EXPECTED_FILE = 'fixtures/release/m127_expected.json';
const OUTPUT_FILE = 'typescript_service_diff_helper_parity_output.json';
