...
const MILESTONE = 'M76';
const SCENARIO_FILE = 'fixtures/commercial/m76_scenario.json';
const EXPECTED_FILE = 'fixtures/commercial/m76_expected.json';
const OUTPUT_FILE = 'commercial_usage_ledger_output.json';
