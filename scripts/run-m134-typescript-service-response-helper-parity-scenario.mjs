...
const SCENARIO_FILE = 'fixtures/release/m134_scenario.json';
const EXPECTED_FILE = 'fixtures/release/m134_expected.json';
const OUTPUT_FILE = 'typescript_service_response_helper_parity_output.json';
