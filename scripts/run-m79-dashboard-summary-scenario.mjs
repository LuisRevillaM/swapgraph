...
const MILESTONE = 'M79';
const SCENARIO_FILE = 'fixtures/commercial/m79_scenario.json';
const EXPECTED_FILE = 'fixtures/commercial/m79_expected.json';
const OUTPUT_FILE = 'dashboard_summary_output.json';
