...
const MILESTONE = 'M126';
const SCENARIO_FILE = 'fixtures/release/m126_scenario.json';
const EXPECTED_FILE = 'fixtures/release/m126_expected.json';
const OUTPUT_FILE = 'typescript_service_helper_parity_output.json';
