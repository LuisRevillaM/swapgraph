...
async function main() {
  const scenarios = [
    {
      name: 'retryable_status_create_intent',
      filter: 'APIClientIntegrationTests/testCreateIntentRetriesRetryableStatusThenSucceeds'
    },
    {
      name: 'optimistic_create_rollback',
      filter: 'IntentsViewModelFeatureTests/testCreateIntentRollsBackOptimisticRowWhenMutationFails'
    },
    {
      name: 'optimistic_cancel_rollback',
      filter: 'IntentsViewModelFeatureTests/testCancelIntentRollsBackWhenMutationFails'
    }
  ];
