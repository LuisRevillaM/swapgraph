...
const MILESTONE = 'M80';
const SCENARIO_FILE = 'fixtures/commercial/m80_scenario.json';
const EXPECTED_FILE = 'fixtures/commercial/m80_expected.json';
const OUTPUT_FILE = 'oauth_client_lifecycle_output.json';
