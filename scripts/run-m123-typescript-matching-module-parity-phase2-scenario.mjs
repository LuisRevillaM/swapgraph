...
const SCENARIO_FILE = 'fixtures/release/m123_scenario.json';
const EXPECTED_FILE = 'fixtures/release/m123_expected.json';
const OUTPUT_FILE = 'typescript_matching_module_parity_phase2_output.json';
