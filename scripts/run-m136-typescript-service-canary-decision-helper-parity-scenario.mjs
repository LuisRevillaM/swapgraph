...
const MILESTONE = 'M136';
const SCENARIO_FILE = 'fixtures/release/m136_scenario.json';
const EXPECTED_FILE = 'fixtures/release/m136_expected.json';
const OUTPUT_FILE = 'typescript_service_canary_decision_helper_parity_output.json';
