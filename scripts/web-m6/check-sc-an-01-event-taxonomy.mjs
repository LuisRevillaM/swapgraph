...
const outPath = path.join(repoRoot, 'artifacts/web-m6/sc-an-01-event-taxonomy-report.json');
...
const samplePayloads = {
  ...
  'marketplace.notification_preferences_opened': { source: 'ui' },
  ...
  'marketplace.push_received': { kind: 'proposal', channel: 'proposal', source: 'window_event' },
  ...
  'marketplace.receipts_list_viewed': { receipt_count: 3, completed_count: 1, failed_count: 2 },
  'marketplace.receipt_opened': { receipt_id: 'receipt_1', cycle_id: 'cycle_1', source: 'notification' },
  ...
  'marketplace.active_receipt_opened': { cycle_id: 'cycle_1' }
};
