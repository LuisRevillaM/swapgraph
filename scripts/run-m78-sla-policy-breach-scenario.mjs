...
const MILESTONE = 'M78';
const SCENARIO_FILE = 'fixtures/commercial/m78_scenario.json';
const EXPECTED_FILE = 'fixtures/commercial/m78_expected.json';
const OUTPUT_FILE = 'sla_policy_breach_output.json';
