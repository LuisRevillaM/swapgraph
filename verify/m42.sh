...
{
  echo "# verify ${M} (consent proof anti-replay + export attestation continuity)"
  ...
  echo "$ AUTHZ_ENFORCE=1 POLICY_CONSENT_TIER_ENFORCE=1 POLICY_CONSENT_PROOF_BIND_ENFORCE=1 POLICY_CONSENT_PROOF_SIG_ENFORCE=1 POLICY_CONSENT_PROOF_REPLAY_ENFORCE=1 POLICY_AUDIT_RETENTION_DAYS=30 OUT_DIR=$OUT_DIR node scripts/run-m42-consent-replay-export-attestation-scenario.mjs"
...
req=(
  ...
  "scripts/run-m42-consent-replay-export-attestation-scenario.mjs"
  "fixtures/delegation/m42_scenario.json"
  "fixtures/delegation/m42_expected.json"
...
AUTHZ_ENFORCE=1 POLICY_CONSENT_TIER_ENFORCE=1 POLICY_CONSENT_PROOF_BIND_ENFORCE=1 POLICY_CONSENT_PROOF_SIG_ENFORCE=1 POLICY_CONSENT_PROOF_REPLAY_ENFORCE=1 POLICY_AUDIT_RETENTION_DAYS=30 OUT_DIR="$OUT_DIR" node scripts/run-m42-consent-replay-export-attestation-scenario.mjs >> "$OUT_DIR/commands.log" 2>&1
...
cp "$OUT_DIR/consent_replay_export_attestation_output.json" "$LATEST_DIR/consent_replay_export_attestation_output.json"
