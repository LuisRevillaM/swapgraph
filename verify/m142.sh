...
AUTHZ_ENFORCE=1 OUT_DIR="$OUT_DIR" node scripts/run-m142-market-deals-threads-scenario.mjs > "$OUT_DIR/commands.log" 2>&1
...
cp "$OUT_DIR/market_deals_threads_output.json" "$LATEST_DIR/market_deals_threads_output.json"
