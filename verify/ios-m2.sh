...

{
  ...
  echo "$ node scripts/ios/run-sc-ux-01.mjs > $OUT_DIR/sc-ux-01.json"
  echo "$ node scripts/ios/run-sc-api-03.mjs > $OUT_DIR/sc-api-03.json"
  echo "$ node scripts/ios/run-sc-rl-02.mjs > $OUT_DIR/sc-rl-02.json"
...
node scripts/ios/run-sc-ux-01.mjs > "$OUT_DIR/sc-ux-01.json"
node scripts/ios/run-sc-api-03.mjs > "$OUT_DIR/sc-api-03.json"
node scripts/ios/run-sc-rl-02.mjs > "$OUT_DIR/sc-rl-02.json"
...
cp "$OUT_DIR/sc-ux-01.json" "$LATEST_DIR/sc-ux-01.json"
cp "$OUT_DIR/sc-api-03.json" "$LATEST_DIR/sc-api-03.json"
cp "$OUT_DIR/sc-rl-02.json" "$LATEST_DIR/sc-rl-02.json"
