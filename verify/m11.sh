...

{
  ...
  echo "$ AUTHZ_ENFORCE=1 OUT_DIR=$OUT_DIR node scripts/run-m11-settlement-events-scenario.mjs"
...
AUTHZ_ENFORCE=1 OUT_DIR="$OUT_DIR" node scripts/run-m11-settlement-events-scenario.mjs >> "$OUT_DIR/commands.log" 2>&1
