# M59 — Rollout governance controls hardening (freeze windows + maintenance-mode + admin-action overlays) (fixtures-first)
...
- `node verify/runner.mjs milestones/M59.yaml` returns `overall=true`.
