# M38 — Advanced delegated write-path policy controls (`max_value_per_day_usd`, consent hooks, audit trail)
...
- `node verify/runner.mjs milestones/M38.yaml` overall=true.
