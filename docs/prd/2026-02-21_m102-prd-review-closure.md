...
Purpose: close discovery decisions for commercial packaging/policy contracts before implementation planning.
...
## PRD approval gate (M102)
M102 PRD is ready for implementation planning only when D1–D8 are explicitly approved or amended.
