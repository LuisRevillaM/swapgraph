# M98 — API + event surface completion contracts (implementation-ready, implemented fixtures-first)
...
- `node verify/runner.mjs milestones/M98.yaml` returns `overall=true`.
