# M37 — Delegation TradingPolicy enforcement across matching/commit/settlement read boundaries (fixtures-first)
...
- `node verify/runner.mjs milestones/M37.yaml` overall=true.
