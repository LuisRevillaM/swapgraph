# M120 — Matching v2 full-primary cutover contract with retained fallback
...
- Rollback latch: once rollback is activated, v2 attempts are suppressed until explicit reset.
